...
Most of these come down to network reality or how airbnb serves its data,
not a bug. Fill this page out with the site-specific cases as you find them.

## Requests start failing or returning 429

airbnb rate-limits like any public site. airbnb already paces
...
Where a surface is gated, airbnb reads a cookie or token you supply

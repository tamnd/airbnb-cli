---
title: "airbnb"
description: "A command line for airbnb."
heroTitle: "airbnb, from the command line"
heroLead: "A command line for airbnb. One pure-Go binary, no API key, output that pipes into the rest of your tools, and a resource-URI driver other programs can address."
...
airbnb links <path>           # the pages it links to, each addressable
...
- **As a command** for reading airbnb by hand or in a script. Start with
  the [quick start](/getting-started/quick-start/).
- **As a resource-URI driver** so a host like
  [ant](https://github.com/tamnd/ant) can address airbnb as
  `airbnb://` URIs and follow links across sites. See
